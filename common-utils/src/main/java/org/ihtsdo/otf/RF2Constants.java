...
public interface RF2Constants {
	...
	enum InactivationIndicator {AMBIGUOUS, DUPLICATE, OUTDATED, ERRONEOUS, LIMITED, MOVED_ELSEWHERE,
		...
		NOT_SEMANTICALLY_EQUIVALENT, MEANING_OF_COMPONENT_UNKNOWN, CLASSIFICATION_DERIVED_COMPONENT, GRAMMATICAL_DESCRIPTION_ERROR, OBSOLETE}
	...
	String SCTID_INACT_OBSOLETE = "41228009"; // |Obsolete (qualifier value)|
