...
public interface RF2Constants {
	...
	public enum ReportActionType {	API_ERROR, DEBUG_INFO, INFO, UNEXPECTED_CONDITION,
		...
		REFSET_MEMBER_ADDED, REFSET_MEMBER_DELETED, REFSET_MEMBER_INACTIVATED, REFSET_MEMBER_REMOVED, REFSET_MEMBER_REACTIVATED,
		...
		LANG_REFSET_CREATED, LANG_REFSET_MODIFIED,
