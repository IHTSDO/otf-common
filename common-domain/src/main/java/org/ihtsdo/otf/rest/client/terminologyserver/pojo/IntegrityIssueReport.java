...
public class IntegrityIssueReport {
	...
	private Map<String, ConceptPojo> axiomsWithMissingOrInactiveReferencedConcept;
	...
	public void setAxiomsWithMissingOrInactiveReferencedConcept(Map<String, ConceptPojo> axiomsWithMissingOrInactiveReferencedConcept) {
		this.axiomsWithMissingOrInactiveReferencedConcept = axiomsWithMissingOrInactiveReferencedConcept;
	}

	public Map<String, ConceptPojo> getAxiomsWithMissingOrInactiveReferencedConcept() {
